...
void quaternion_product(float * retu, const float *q1, const float *q2);
...
void quaternion_normalize_t(float *retu, float t);
void quaternion_normalize_1(float *retu);
...
void v3d_normalize(float *v3d);
void v3d_normalize_t(float *v3d, float t);
