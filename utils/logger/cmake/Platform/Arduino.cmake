...
function(get_arduino_flags COMPILE_FLAGS_VAR LINK_FLAGS_VAR BOARD_ID MANUAL)
    ...
    if(BOARD_CORE)
        ...
        #message("stawel: ${BOARD_ID}${ARDUINO_CPUMENU}.build.f_cpu = ${${BOARD_ID}${ARDUINO_CPUMENU}.build.f_cpu}")
        #message("stawel: ${BOARD_ID}${ARDUINO_CPUMENU}.build.mcu = ${${BOARD_ID}${ARDUINO_CPUMENU}.build.mcu} ")
